...
const DEMOGRAPHIC_FIELDS = [
    ...
    },
    {
        ...
        hidden: false,
        options: [
            { value: 'under_1000', label: 'Unter 1000 €' },
            { value: '1000_1999', label: '1.000 bis 1.999 €' },
            { value: '2000_2999', label: '2.000 bis 2.999 €' },
            { value: '3000_3999', label: '3.000 bis 3.999 €' },
            { value: '4000_4999', label: '4.000 bis 4.999 €' },
            { value: '5000_5999', label: '5.000 bis 5.999 €' },
            { value: '6000_6999', label: '6.000 bis 6.999 €' },
            { value: '7000_7999', label: '7.000 bis 7.999 €' },
            { value: '8000_8999', label: '8.000 bis 8.999 €' },
            { value: '9000_9999', label: '9.000 bis 9.999 €' },
            { value: '10000_plus', label: '10.000 € oder mehr' },
        ],
    },
    {
